...
TRANSLATIONS = {
    ...
    "billing_monthly_pro": {"en": "Monthly — A$99/mo", "zh": "月付 — A$99/月"},
    "billing_annual_pro": {"en": "Annual — A$49/mo (save 50%)", "zh": "年付 — A$49/月（省50%）"},
    "billing_monthly_max": {"en": "Monthly — A$199/mo", "zh": "月付 — A$199/月"},
    ...
    "pricing_max_title": {"en": "Max", "zh": "Max"},
    "pricing_pro_features": {"en": "50 analyses / month\nAll 3 tools included\nEmail support", "zh": "50 次分析 / 月\n包含全部 3 个工具\n邮件支持"},
    "pricing_max_features": {"en": "200 analyses / month\nAll 3 tools included\nPriority support", "zh": "200 次分析 / 月\n包含全部 3 个工具\n优先支持"},
    "pricing_monthly": {"en": "Monthly", "zh": "月付"},
    "pricing_annual": {"en": "Annual", "zh": "年付"},
    "pricing_save": {"en": "SAVE 50%", "zh": "省50%"},
    "pricing_per_month": {"en": "/mo", "zh": "/月"},
    "pricing_btn_pro": {"en": "Choose Pro", "zh": "选择 Pro"},
    "pricing_btn_max": {"en": "Choose Max", "zh": "选择 Max"},
    "pricing_current": {"en": "Current Plan", "zh": "当前方案"},
    "view_plans": {"en": "Membership Plans", "zh": "会员方案"},
    ...
    "t1_video_title": {"en": "Cinematic Walkthrough Video", "zh": "电影级环绕动画"},
    "t1_video_caption": {
        "en": "Generate a cinematic fly-around video from the aerial rendering using ArchiMind Pro.",
        "zh": "使用 ArchiMind Pro 从鸟瞰渲染图生成电影级环绕动画视频。",
    },
    ...
    "t2_tab_budget": {"en": "💰 Budget Estimate", "zh": "💰 预算估算"},
    ...
    "t2_no_budget": {"en": "No budget estimate generated.", "zh": "未生成预算估算。"},
    "t2_download_report": {"en": "Download Full Report (.md)", "zh": "下载完整报告 (.md)"},
    "t2_download_qto": {"en": "Download QTO (.csv)", "zh": "下载工程量 (.csv)"},
    "t2_download_qto_xlsx": {"en": "QTO Excel (.xlsx)", "zh": "工程量 Excel (.xlsx)"},
    "t2_download_budget": {"en": "Budget Excel (.xlsx)", "zh": "预算表 Excel (.xlsx)"},
    ...
    "af_budget": {"en": "💰 Budget Estimate", "zh": "💰 预算估算"},
    # Tab2 progress
    ...
    "admin_stats": {"en": "Total: {total} · Beta: {beta} · Pro: {pro} · Max: {max}", "zh": "总用户: {total} · Beta: {beta} · Pro: {pro} · Max: {max}"},
    "admin_upgrade_beta": {"en": "⬆️ Beta", "zh": "⬆️ Beta"},
    "admin_upgrade_pro": {"en": "⬆️ Pro", "zh": "⬆️ Pro"},
    "admin_upgrade_max": {"en": "⬆️ Max", "zh": "⬆️ Max"},
